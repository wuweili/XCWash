...
//    [self addSubview:_textLabel];
    ...
    _oneStarButton = [UIButton buttonWithType:UIButtonTypeCustom];
      _oneStarButton.backgroundColor = [UIColor clearColor];
...
//    [self addSubview:_oneStarReflectionView];
    ...
    _twoStarButton.backgroundColor = [UIColor clearColor];
...
//    [self addSubview:_twoStarReflectionView];
    ...
    [self addSubview:_threeStarButton];
      ...
      _threeStarButton.backgroundColor = [UIColor clearColor];
...
//    [self addSubview:_threeStarReflectionView];
    ...
    [self addSubview:_fourStarButton];
      ...
      _fourStarButton.backgroundColor = [UIColor clearColor];
...
//    [self addSubview:_fourStarReflectionView];
    ...
    [self addSubview:_fiveStarButton];
      ...
      _fiveStarButton.backgroundColor = [UIColor clearColor];
...
- (void)layoutSubviews {
  ...
  [_textLabel sizeToFit];
    ...
    CGFloat starButtonWidth = 30;//24.f;
    CGFloat starButtonHeight = 30;//24.f;
    CGFloat starButtonSpacing = 8;//20.f;
  CGFloat centerButtonLeft = (self.bounds.size.width - starButtonWidth) / 2;   //85.5
